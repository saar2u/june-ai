...
const Homepage = () => {
  return (
    <>
      <Helmet>
        <title>June AI - Your AI that grows with you</title>
        <meta 
          name="description" 
          content="Experience personalized AI intelligence that adapts to your unique needs. From creative brainstorming to complex analysis, June AI evolves with your workflow and amplifies your potential." 
        />
        <meta name="keywords" content="AI assistant, artificial intelligence, productivity, enterprise AI, personalized AI, June AI" />
        <meta property="og:title" content="June AI - Your AI that grows with you" />
        <meta property="og:description" content="Transform your productivity with June AI's intelligent assistance. Choose from specialized AI models and seamless enterprise integrations." />
          ...
          <div className="max-w-7xl mx-auto px-4 lg:px-6 py-12">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><a href="#" className="text-text-secondary hover:text-primary transition-colors">Press</a></li>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><a href="#" className="text-text-secondary hover:text-primary transition-colors">GDPR</a></li>
                </ul>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-border">
              <div className="flex items-center space-x-3 mb-4 md:mb-0">
                ...
                <span className="font-semibold text-text-primary">June AI</span>
              </div>

              <div className="flex items-center space-x-6">
                <p className="text-sm text-text-secondary">
                  © {new Date()?.getFullYear()} June AI. All rights reserved.
                </p>
